...
def check_city(inp, exp):
    print(f"{inp.name} {type(inp.name)}")
    print(f"{exp.name} {type(exp.name)}")
    print(f"{inp.lat} {type(inp.lat)}")
    print(f"{exp.lat} {type(exp.lat)}")
    print(f"{inp.lon} {type(inp.lon)}")
    print(f"{exp.lon} {type(exp.lon)}")
